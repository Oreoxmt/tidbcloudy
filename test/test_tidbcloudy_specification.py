...
class TestUpdateClusterConfig:
    def test_default(self):
        ...
        assert cluster_config.to_object() == {"config": {"components": {}}}
    ...
    def test_update_component(self):
        ...
        assert cluster_config.to_object() == {
            "config": {
                "components": {
                    "tidb": {"node_quantity": 2, "node_size": "8C16G"},
                    "tikv": {"node_quantity": 1, "node_size": "8C32G", "storage_size_gib": 400},
                    "tiflash": {"node_quantity": 3, "node_size": "8C64G", "storage_size_gib": 500},
                }
            }
        }
